...
You can customize the output of ``django-bs4`` by writing your own templates. These templates are available:
...
There are two more templates, ``bs4/base.html`` and ``bs4/pagination.html``. You should consider these private for now, meaning you can use them but not modify them.
